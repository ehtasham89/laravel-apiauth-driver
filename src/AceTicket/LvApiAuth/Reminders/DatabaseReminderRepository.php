<?php namespace AceTicket\LvApiAuth\Reminders;

use Carbon\Carbon;
use Illuminate\Database\Connection;
use AceTicket\LvApiAuth\Reminders\User;
use AceTicket\LvApiAuth\Reminders\ReminderRepositoryInterface;
use Config;
...
class DatabaseReminderRepository implements ReminderRepositoryInterface {
	...
	{
		return array('email' => $email, 'reminder_token' => $token, 'created_at' => new Carbon);
	}
